...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/round-mud-644d
```

A live public deployment of this template is available at [https://round-mud-644d.templates.workers.dev](https://round-mud-644d.templates.workers.dev)
